...
# Install Helm:
echo -e "${BGreen}Installing Helm...${Color_Off}"
curl --insecure --silent --show-error -fsSL -o get_helm.sh https://raw.githubusercontent.com/helm/helm/main/scripts/get-helm-3
